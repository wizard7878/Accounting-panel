function pieChart(rialis, gramis, longterms){
    (function (factory) {
        ...
        const handleTooltipPosition = ([e, , t, , o]) => {
            if (window.innerWidth <= 540) {
                ...
                return r[e[0] < o.viewSize[0] / 2 ? "left" : "right"] = 5, r
            }
            return null
        };
        ...
        const issuesDiscoveredChartInit = () => {
            const {
                getColor: e,
                getData: t
            } = window.phoenix.utils, i = document.querySelector(".echart-issue-chart");
            if (i) {
                const o = t(i, "echarts"),
        ...
        const zeroBurnOutChartInit = () => {
            const {
                ...
                getData: e,
                getPastDates: o
            } = window.phoenix.utils, a = document.querySelector(".echart-zero-burnout-chart");
            if (a) {
                const i = e(a, "echarts"),
